...
class Migration_Install_Setup extends CI_Migration 
{
	...
	public function up() {
		...
		$tables = [
			...
			'populations' => [
				"`population_id` INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT",
  			"`population_count` BIGINT(11) NOT NULL",
				"`country_id` INT(11) NOT NULL"
			],

			'gdps' => [
				"`gdp_id` INT(11) NOT NULL PRIMARY KEY AUTO_INCREMENT",
  			"`gdp_number` FLOAT(9, 2) NOT NULL",
				"`country_id` INT(11) NOT NULL"
			],
		...
		$this->db->simple_query(
			"INSERT INTO `tbl_countries` (`country_id`, `country_iso`, `country_name`, `country_nicename`, `country_iso3`, `country_numcode`, `country_phonecode`) VALUES
	...
	public function down() {
		$tables = [ 'auth_attempts', 'sessions', 'categories', 'logs', 'user_meta', 'user_login', 'locations' ];
